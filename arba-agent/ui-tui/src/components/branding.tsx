...
const TAG_FULL = 'Arcadia Global Teknologi'
const TAG_MID = 'Arcadia Global Teknologi'
const TAG_TINY = 'Arcadia Global Teknologi'
const HIDE_BELOW = 34
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Arcadia Global Teknologi</Text>
          </Text>
