"""ntfy platform adapter (Arba plugin).
...
``plugins/platforms/ntfy/``. The Arba plugin loader scans the
...
async def _standalone_send(
    ...
    *,
    ...
    ``arba cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Arba dependency",
