"""
Microsoft Teams platform adapter for Arba.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Arba"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"Arba\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
