...
if [ "$needs_chown" = true ]; then
    ...
    # Arba-owned subdirs: recursive chown is safe here because these are
    ...
    # Arba-owned trees under $INSTALL_DIR must be re-chowned when the UID
...
# directory. agent-browser (the runtime CLI Arba spawns for the
