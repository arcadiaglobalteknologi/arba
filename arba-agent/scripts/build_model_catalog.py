#!/usr/bin/env python3
"""Build the Arba Model Catalog — a centralized JSON manifest of curated models.
...
Arba CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Arba release.
