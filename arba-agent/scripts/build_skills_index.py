#!/usr/bin/env python3
"""Build the Arba Skills Index — a centralized JSON catalog of all skills.
...
`arba skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building Arba Skills Index...", flush=True)
