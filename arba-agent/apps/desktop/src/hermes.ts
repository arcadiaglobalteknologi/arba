...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Arba gateway connection closed',
      connectErrorMessage: 'Could not connect to Arba gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Arba gateway is not connected',
...
// curation `arba model` does — for Nous it honors the free/paid tier so a
