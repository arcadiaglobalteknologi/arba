...
export const FIELD_DESCRIPTIONS: Record<string, string> = {
  ...
  timezone: 'Used when Arba needs local time context. Blank uses the system timezone.',
  ...
  file_read_max_chars: 'Maximum characters Arba can read from one file request.',
  'approvals.mode': 'How Arba handles commands that need explicit approval.',
  ...
  'agent.max_turns': 'Upper bound for tool-calling turns before Arba stops a run.'
}
