...
version: 1.0.0
author: arceus77-7, enhanced by Arba
license: MIT
...
- `tmux` available for stable authenticated sessions during Arba terminal calls (desktop app flow only)
...
### Service Account (recommended for Arba)
...
## Arba Execution Pattern (desktop app flow)

Arba terminal commands are non-interactive by default and can lose auth context between calls.
