...
# ============================================================================
# PATH setup — symlink arba into a user-facing bin dir
# ============================================================================

echo -e "${CYAN}→${NC} Setting up arba command..."
...
echo "Other commands:"
echo "  arba status        # Check configuration"
if is_termux; then
    echo "  arba gateway       # Run gateway in foreground"
else
    echo "  arba gateway install # Install gateway service (messaging + cron)"
fi
echo "  arba cron list     # View scheduled jobs"
echo "  arba doctor        # Diagnose issues"
echo ""
