...
This skill is designed for the Arba agent. It uses Arba tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Arba skills for specific phases:
