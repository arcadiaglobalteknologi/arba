...
version: 1.0.0
author: Arba (adapted from gsd-build/get-shit-done)
license: MIT
...
**Verify variants visually — use Arba' browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
