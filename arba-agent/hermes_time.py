...
Invalid timezone values log a warning and fall back safely — Arba never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Arba requires 3.9+)
