...
# Audio file extensions Arba recognizes for native audio delivery.
...
def _thread_metadata_for_source(source, reply_to_message_id: str | None = None) -> dict | None:
    ...
    value. Telegram private-chat topics created through Arba' DM-topic helper
...
def _reply_anchor_for_event(event) -> str | None:
    ...
    replying to the triggering message. Arba-created Telegram private-chat
...
def _media_delivery_denied_paths() -> List[Path]:
    ...
    # The active Arba profile and shared Arba root both contain control
...
def validate_media_delivery_path(path: str) -> Optional[str]:
    ...
    Arba-managed cache, under an operator-allowlisted root
