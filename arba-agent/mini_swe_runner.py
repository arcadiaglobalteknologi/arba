#!/usr/bin/env python3
"""
SWE Runner with Arba Trajectory Format

A runner that uses Arba's built-in execution environments
(local, docker, modal) and outputs trajectories in the Arba format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Arba's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Arba format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Arba format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Arba's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Arba Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Arba's built-in execution environments
    and outputs trajectories in Arba format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Arba trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Arba trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Arba trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Arba Trajectory Format")
    print("=" * 60)
