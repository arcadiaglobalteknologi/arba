...
def mask_secret(
    ...
    *,
    ...
    Canonical helper for display-time redaction across Arba — used by
    ``arba config``, ``arba status``, ``arba dump``, and anywhere
...
def redact_sensitive_text(text: str, *, force: bool = False, code_file: bool = False) -> str:
    ...
    for URLs, ``"eyJ" in text`` for JWTs). On a typical arba log line
