...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Arba never re-renders parts of this string mid-
    ...
    # Pointer to the hermes-agent skill + docs for user questions about Arba itself.
    ...
    # Active-profile hint — names the Arba profile the agent is running
    ...
    if active_profile == "default":
        stable_parts.append(
            "Active Arba profile: default. Other profiles (if any) live "
        ...
        stable_parts.append(
            f"Active Arba profile: {active_profile}. This session reads "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Arba never rebuilds or reinjects parts of it
