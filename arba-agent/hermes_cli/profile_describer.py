...
Used by ``arba profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Arba kanban board.
...
Rules:
  ...
  - Never write "Arba profile" or other meta-narration.
