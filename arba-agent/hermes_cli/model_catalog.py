...
The Arba docs site hosts a JSON manifest of curated models for providers
...
DEFAULT_CATALOG_URL = (
    "https://arcadiaglobalteknologi.com/docs/api/model-catalog.json"
)
...
DEFAULT_CATALOG_FALLBACK_URLS: tuple[str, ...] = (
    "https://raw.githubusercontent.com/arcadiaglobalteknologi/arba/master/arba-agent/website/static/api/model-catalog.json",
)
DEFAULT_TTL_HOURS = 1
...
def reset_cache() -> None:
    """Clear the in-process cache. Used by tests and ``arba model --refresh``."""
    global _catalog_cache, _catalog_cache_source_mtime
    _catalog_cache = None
