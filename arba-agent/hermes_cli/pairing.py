...
Usage:
    arba pairing list              # Show all pending + approved users
    arba pairing approve <platform> <code>  # Approve a pairing code
    arba pairing revoke <platform> <user_id> # Revoke user access
    arba pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle arba pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: arba pairing {list|approve|revoke|clear-pending}")
        print("Run 'arba pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'arba pairing list' to see pending codes.\n")
