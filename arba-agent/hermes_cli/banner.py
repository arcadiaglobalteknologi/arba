...
_UPSTREAM_REPO_URL = "https://github.com/arcadiaglobalteknologi/arba.git"
...
def check_for_updates() -> Optional[int]:
    """Check whether a Arba update is available.
...
def _resolve_repo_dir() -> Optional[Path]:
    """Return the active Arba git checkout, or None if this isn't a git install.
...
_RELEASE_URL_BASE = "https://github.com/arcadiaglobalteknologi/arba/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    Arba checkout. Cached per-process. Release URL always points at the
    canonical arcadiaglobalteknologi/arba repo (forks don't get a link).
    """
...
def format_banner_version_label() -> str:
    ...
    base = f"Arba v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]Arcadia Global Teknologi[/]")
