"""Persistent session goals — the Ralph loop for Arba.

A goal is a free-form user objective that stays active across turns. After
each turn completes, a small judge call asks an auxiliary model "is this
goal satisfied by the assistant's last response?". If not, Arba feeds a
...
def run_kanban_goal_loop(
    *,
    ...
    (``arba -p <profile> chat -q "work kanban task <id>"``). The worker's
