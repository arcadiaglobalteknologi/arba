...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Arba"                  # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Arba "         # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Arba"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Arba — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Arba",
            "welcome": "Welcome to Arba! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Arba ",
            "prompt_symbol": "❯",
