...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="hermes-acp",
        description="Run Arba as an ACP stdio server.",
    )
    parser.add_argument("--version", action="store_true", help="Print Arba version and exit")
    parser.add_argument(
        "--check",
        action="store_true",
...
def _run_setup_browser(assume_yes: bool = False) -> int:
    ...
    with ``arba postinstall`` and the runtime lazy installer.
