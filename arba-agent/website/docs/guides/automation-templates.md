...
hermes cron create "0 2 * * *" \
  "You are a project manager triaging the arcadiaglobalteknologi/arba GitHub repo.

1. Run: gh issue list --repo arcadiaglobalteknologi/arba --state open --json number,title,labels,author,createdAt --limit 30
...
hermes cron create "0 9 * * 1" \
  "Scan the arcadiaglobalteknologi/arba repo for documentation drift.

1. Run: gh pr list --repo arcadiaglobalteknologi/arba --state merged --json number,title,files,mergedAt --limit 30
