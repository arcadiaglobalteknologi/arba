...
If a model is genuinely missing, [open an issue](https://github.com/arcadiaglobalteknologi/arba/issues) — we surface the Portal's catalog to Hermes and gaps usually mean a routing config we can update.
