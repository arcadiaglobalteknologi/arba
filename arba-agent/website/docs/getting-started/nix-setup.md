...
nix run github:arcadiaglobalteknologi/arba -- setup
nix run github:arcadiaglobalteknologi/arba -- chat

# Or install persistently
nix profile install github:arcadiaglobalteknologi/arba
hermes setup
hermes chat
```
...
```bash
nix profile install github:arcadiaglobalteknologi/arba#messaging
```

For all optional extras (voice, all providers, all platforms):

```bash
nix profile install github:arcadiaglobalteknologi/arba#full
```
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:arcadiaglobalteknologi/arba";
  };
...
```nix
{
  inputs.hermes-agent.url = "github:arcadiaglobalteknologi/arba";
