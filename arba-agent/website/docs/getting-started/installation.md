...
- **Desktop downloads:** [GitHub Releases](https://github.com/arcadiaglobalteknologi/arba/releases/latest)
...
Native Windows runs Hermes without WSL — the CLI, gateway, TUI, and tools all work natively. (Both native and WSL2 installs coexist cleanly; see the feature note below for the one WSL2-only feature.) Found a bug? Please [file issues](https://github.com/arcadiaglobalteknologi/arba/issues).
