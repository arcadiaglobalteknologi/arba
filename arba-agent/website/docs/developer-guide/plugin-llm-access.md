...
[`hermes-example-plugins`](https://github.com/arcadiaglobalteknologi/arba-example-plugins/tree/main/plugin-llm-example)
...
[`plugin-llm-async-example`](https://github.com/arcadiaglobalteknologi/arba-example-plugins/tree/main/plugin-llm-async-example)
in the same repo.
...
* Implementation: [`agent/plugin_llm.py`](https://github.com/arcadiaglobalteknologi/arba/blob/master/arba-agent/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/arcadiaglobalteknologi/arba/blob/master/arba-agent/tests/agent/test_plugin_llm.py)
* Reference plugins (companion repo):
  * [`plugin-llm-example`](https://github.com/arcadiaglobalteknologi/arba-example-plugins/tree/main/plugin-llm-example) — sync structured extraction with image input
  * [`plugin-llm-async-example`](https://github.com/arcadiaglobalteknologi/arba-example-plugins/tree/main/plugin-llm-async-example) — async with `asyncio.gather()`
