...
[Download the Hermes Desktop installer](https://arcadiaglobalteknologi.com/desktop) from our website and run it.
...
```bash
curl -fsSL https://raw.githubusercontent.com/arcadiaglobalteknologi/arba/main/scripts/install.sh | bash -s -- --include-desktop
```
...
The [manual update process](https://arcadiaglobalteknologi.com/docs/getting-started/updating) also works with the GUI.
