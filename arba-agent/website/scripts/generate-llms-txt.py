...
Both publish at:
  https://arcadiaglobalteknologi.com/docs/llms.txt
  https://arcadiaglobalteknologi.com/docs/llms-full.txt
...
SITE_BASE = "https://arcadiaglobalteknologi.com/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Arcadia Global Teknologi A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/arcadiaglobalteknologi/"
        "arba/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/arcadiaglobalteknologi/arba")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://arcadiaglobalteknologi.com/docs\n",
        "Short index: https://arcadiaglobalteknologi.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
