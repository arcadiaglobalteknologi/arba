...
```bash
pip install git+https://github.com/arcadiaglobalteknologi/arba.git
```

或使用 [uv](https://docs.astral.sh/uv/)：

```bash
uv pip install git+https://github.com/arcadiaglobalteknologi/arba.git
```

也可以在 `requirements.txt` 中固定版本：

```text
hermes-agent @ git+https://github.com/arcadiaglobalteknologi/arba.git
```
