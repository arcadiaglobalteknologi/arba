...
def _guard_agent_created_enabled() -> bool:
    ...
    on via `arba config set skills.guard_agent_created true`.
    """
    try:
    ...
    try:
        ...
        if rec.get("pinned"):
            return (
                ...
                f"`arba curator unpin {name}` if they want to delete it. "
...
def _find_skill_in_other_profiles(name: str) -> List[Tuple[str, Path]]:
    """Look for ``name`` under SKILL.md across OTHER Arba profiles.
    ...
    if others:
        if len(others) == 1:
            ...
            base += (
                ...
                f"another profile, switch profiles (`arba -p "
            ...
            base += (
                ...
                f"Switch profiles (`arba -p <name>`) to edit there, or "
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "will refuse with a message pointing the user to `arba curator unpin <name>`. "
