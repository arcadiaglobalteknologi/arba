...
Trust levels:
  - builtin:   Ships with Arba. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references Arba secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references Arba configuration files directly"),
...
# scan. `.skillignore` is the Arba-native name; `.clawhubignore` is honored
