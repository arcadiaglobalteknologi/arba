...
def _find_all_skills(*, skip_disabled: bool = False) -> List[Dict[str, Any]]:
    ...
    Args:
        skip_disabled: If True, return ALL skills regardless of disabled
            state (used by ``arba skills`` config UI). Default False
        ...
        return json.dumps(
            {
                ...
                "error": (
                    ...
                    f"Re-enable with: arba plugins enable {namespace}"
                ),
            },
            ensure_ascii=False,
        )
            ...
            return json.dumps(
                {
                    ...
                    "error": (
                        ...
                        "Enable it with `arba skills` or inspect the files directly on disk."
                    ),
                },
                ensure_ascii=False,
            )
