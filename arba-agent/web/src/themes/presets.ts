...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Arba Teal",
  description: "Classic dark teal — the canonical Arba look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Arba look, ported from the
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Arba Teal (Large)",
  description: "Arba Teal with bigger fonts and roomier spacing",
