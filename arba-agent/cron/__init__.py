"""
Cron job scheduling system for Arba.
...
Cron jobs are executed automatically by the gateway daemon:
    arba gateway install    # Install as a user service
    sudo arba gateway install --system  # Linux servers: boot-time system service
    arba gateway            # Or run in foreground
