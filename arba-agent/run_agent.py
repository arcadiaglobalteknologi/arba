...
def _routermint_headers() -> dict:
    ...
    return {
        "User-Agent": f"ArbaAgent/{_HERMES_VERSION}",
    }
...
class AIAgent:
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        """
        Preload the LM Studio model with at least Arba' minimum context.
        """
    ...
    def _vprint(self, *args, force: bool = False, **kwargs):
        ...
        parseable single-query flows such as ``arba chat -q``. In that mode,
    ...
    def _decorate_xai_entitlement_error(detail: str) -> str:
        ...
        SuperGrok subscribers can use Arba against xai-oauth.  Lots of
    ...
    def _try_refresh_codex_client_credentials(self, *, force: bool = True) -> bool:
        ...
        # pool entry (``arba auth add xai-oauth``) whose tokens belong to
