...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `arba tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    # ==========================================================================
    # Full Arba toolsets (CLI + messaging platforms)
    #
    ...
    "hermes-cron": {
        ...
        # core tools users see interactively — then `arba tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as hermes-cli; gated by `arba tools`",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-email": {
        "description": "Email bot toolset - interact with Arba via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-sms": {
        "description": "SMS bot toolset - interact with Arba via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
